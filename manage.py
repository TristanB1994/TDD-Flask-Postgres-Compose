...
# docker_compose_file = "docker/development.yml" # docker_compose_cmdline = ["docker-compose", "-f", docker_compose_file]
...
def create_initial_db():
    ...
    try:
        ...
        print(
            f"the database: {os.getenv('APPLICATION_DB')} alread exists and will not be recreated"
        )
